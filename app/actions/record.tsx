...
export async function createRecordAction(formData: FormData) {
    ...
    const remark =
        rawRemark && rawRemark.trim() !== "" ? rawRemark.trim() : null;
    ...
    try {
        ...
        if (rawRows.length === 0) {
            return {
                success: false,
                message:
                    "Berkas Excel yang diunggah terbaca hampa atau kosong.",
                inserted: 0,
                skipped: [],
            };
        }
        ...
        return {
            success: false,
            message:
                "Gagal memproses berkas Excel karena error internal database.",
            inserted: 0,
            skipped: [],
        };
    }
